...
def diam():
    p_diam=subprocess.Popen(["python3", "/home/pi/Robot_19/kontrol_motor_diam.py"], stdout=PIPE, stderr=PIPE)
...
class App:
    def __init__(self, master, video_source=1):
        ...
        self.manual_button=tkinter.Button(master, text="Manual", width=50, command=lambda:[ self.close_window(), self.manual_lunch()])
