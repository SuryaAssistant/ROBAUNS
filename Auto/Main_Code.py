...
############################################Mulai debugging disini sampai line kama11
def ruang_kontrol():
    ...
    if ruang_kontrol_state== True:
        ...
        if variabel_cpoint == Point_dua:
            R1()
            print("last checkpoint ", variabel_cpoint)
        if variabel_cpoint == Point_tiga:
            R2()
            print("last checkpoint ", variabel_cpoint)
        if variabel_cpoint == Point_empat:
            R3()
            print("last checkpoint ", variabel_cpoint)
        if variabel_cpoint == Point_lima:
            R4()
            print("last checkpoint ", variabel_cpoint)
        if variabel_cpoint == Point_enam:
            R5()
            print("last checkpoint ", variabel_cpoint)
        if variabel_cpoint == Point_tujuh:
            R6()
            print("last checkpoint ", variabel_cpoint)
        if variabel_cpoint == Point_delapan:
            R7()
            print("last checkpoint ", variabel_cpoint)
        if variabel_cpoint == Point_sembilan:
            R8()
            print("last checkpoint ", variabel_cpoint)
        if variabel_cpoint == Point_sepuluh:
            R9()
            print("last checkpoint ", variabel_cpoint)
        if variabel_cpoint == Point_sebelas:
            R10()
            print("last checkpoint ", variabel_cpoint)
        if variabel_cpoint == Point_duabelas:
            R11()
            print("last checkpoint ", variabel_cpoint)
...
def kamar7():
    ...
    if kamar7_state== True:
        print ('menuju kamar A7')
        variabel_tujuan = Point_delapan
        if variabel_cpoint == Point_satu:
            RK()
            print("last checkpoint ", variabel_cpoint)
        if variabel_cpoint == Point_dua:
...
def kamar8():
    ...
    if kamar8_state== True:
        ...
        variabel_tujuan = Point_sembilan
        if variabel_cpoint == Point_satu:
            RK()
            print("last checkpoint ", variabel_cpoint)
        if variabel_cpoint == Point_dua:
...
def kamar11():
    ...
    if kamar11_state== True:
        ...
        variabel_tujuan = Point_duabelas
        if variabel_cpoint == Point_satu:
            RK()
            print("last checkpoint ", variabel_cpoint)
        if variabel_cpoint == Point_dua:
...
def R2():
    ...
    if variabel_tujuan == Point_empat:
        print("Dari R2 menuju R3")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_lima:
        print("Dari R2 menuju R4")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_enam:
        print("Dari R2 menuju R5")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_tujuh:
        print("Dari R2 menuju R6")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_delapan:
        print("Dari R2 menuju R7")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_sembilan:
        print("Dari R2 menuju R8")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_sepuluh:
        print("Dari R2 menuju R9")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_sebelas:
        print("Dari R2 menuju R10")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_duabelas:
        print("Dari R2 menuju R11")
        """"""
        variabel_cpoint = variabel_tujuan
...
def R3():
    ...
    global variabel_cpoint    
    if variabel_tujuan == Point_satu:
        print("Dari R3 menuju RK")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_dua:
        print("Dari R3 menuju R1")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_tiga:
        print("Dari R3 menuju R2")
        """"""
        variabel_cpoint = variabel_tujuan
    ...
    if variabel_tujuan == Point_lima:
        print("Dari R3 menuju R4")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_enam:
        print("Dari R3 menuju R5")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_tujuh:
        print("Dari R3 menuju R6")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_delapan:
        print("Dari R3 menuju R7")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_sembilan:
        print("Dari R3 menuju R8")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_sepuluh:
        print("Dari R3 menuju R9")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_sebelas:
        print("Dari R3 menuju R10")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_duabelas:
        print("Dari R3 menuju R11")
        """"""
        variabel_cpoint = variabel_tujuan
...
def R4():
    ...
    global variabel_cpoint    
    if variabel_tujuan == Point_satu:
        print("Dari R4 menuju RK")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_dua:
        print("Dari R4 menuju R1")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_tiga:
        print("Dari R4 menuju R2")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_empat:
        print("Dari R4 menuju R3")
        """"""
        variabel_cpoint = variabel_tujuan
    ...
    if variabel_tujuan == Point_enam:
        print("Dari R4 menuju R5")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_tujuh:
        print("Dari R4 menuju R6")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_delapan:
        print("Dari R4 menuju R7")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_sembilan:
        print("Dari R4 menuju R8")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_sepuluh:
        print("Dari R4 menuju R9")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_sebelas:
        print("Dari R4 menuju R10")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_duabelas:
        print("Dari R4 menuju R11")
        """"""
        variabel_cpoint = variabel_tujuan
...
def R5():
    ...
    global variabel_cpoint    
    if variabel_tujuan == Point_satu:
        print("Dari R5 menuju RK")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_dua:
        print("Dari R5 menuju R1")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_tiga:
        print("Dari R5 menuju R2")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_empat:
        print("Dari R5 menuju R3")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_lima:
        print("Dari R5 menuju R4")
        """"""
        variabel_cpoint = variabel_tujuan
    ...
    if variabel_tujuan == Point_tujuh:
        print("Dari R5 menuju R6")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_delapan:
        print("Dari R5 menuju R7")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_sembilan:
        print("Dari R5 menuju R8")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_sepuluh:
        print("Dari R5 menuju R9")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_sebelas:
        print("Dari R5 menuju R10")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_duabelas:
        print("Dari R5 menuju R11")
        """"""
        variabel_cpoint = variabel_tujuan
...
def R6():
    ...
    global variabel_cpoint    
    if variabel_tujuan == Point_satu:
        print("Dari R6 menuju RK")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_dua:
        print("Dari R6 menuju R1")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_tiga:
        print("Dari R6 menuju R2")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_empat:
        print("Dari R6 menuju R3")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_lima:
        print("Dari R6 menuju R4")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_enam:
        print("Dari R6 menuju R5")
        """"""
        variabel_cpoint = variabel_tujuan
    ...
    if variabel_tujuan == Point_delapan:
        print("Dari R6 menuju R7")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_sembilan:
        print("Dari R6 menuju R8")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_sepuluh:
        print("Dari R6 menuju R9")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_sebelas:
        print("Dari R6 menuju R10")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_duabelas:
        print("Dari R6 menuju R11")
        """"""
        variabel_cpoint = variabel_tujuan
...
def R7():
    ...
    global variabel_cpoint    
    if variabel_tujuan == Point_satu:
        print("Dari R7 menuju RK")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_dua:
        print("Dari R7 menuju R1")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_tiga:
        print("Dari R7 menuju R2")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_empat:
        print("Dari R7 menuju R3")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_lima:
        print("Dari R7 menuju R4")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_enam:
        print("Dari R7 menuju R5")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_tujuh:
        print("Dari R7 menuju R6")
        """"""
        variabel_cpoint = variabel_tujuan
    ...
    if variabel_tujuan == Point_sembilan:
        print("Dari R7 menuju R8")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_sepuluh:
        print("Dari R7 menuju R9")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_sebelas:
        print("Dari R7 menuju R10")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_duabelas:
        print("Dari R7 menuju R11")
        """"""
        variabel_cpoint = variabel_tujuan
...
def R8():
    ...
    global variabel_cpoint    
    if variabel_tujuan == Point_satu:
        print("Dari R8 menuju RK")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_dua:
        print("Dari R8 menuju R1")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_tiga:
        print("Dari R8 menuju R2")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_empat:
        print("Dari R8 menuju R3")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_lima:
        print("Dari R8 menuju R4")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_enam:
        print("Dari R8 menuju R5")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_tujuh:
        print("Dari R8 menuju R6")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_delapan:
        print("Dari R8 menuju R7")
        """"""
        variabel_cpoint = variabel_tujuan
    ...
    if variabel_tujuan == Point_sepuluh:
        print("Dari R8 menuju R9")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_sebelas:
        print("Dari R8 menuju R10")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_duabelas:
        print("Dari R8 menuju R11")
        """"""
        variabel_cpoint = variabel_tujuan
...
def R9():
    ...
    global variabel_cpoint    
    if variabel_tujuan == Point_satu:
        print("Dari R9 menuju RK")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_dua:
        print("Dari R9 menuju R1")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_tiga:
        print("Dari R9 menuju R2")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_empat:
        print("Dari R9 menuju R3")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_lima:
        print("Dari R9 menuju R4")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_enam:
        print("Dari R9 menuju R5")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_tujuh:
        print("Dari R9 menuju R6")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_delapan:
        print("Dari R9 menuju R7")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_sembilan:
        print("Dari R9 menuju R8")
        """"""
        variabel_cpoint = variabel_tujuan
    ...
    if variabel_tujuan == Point_sebelas:
        print("Dari R9 menuju R10")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_duabelas:
        print("Dari R9 menuju R11")
        """"""
        variabel_cpoint = variabel_tujuan
...
def R10():
    ...
    global variabel_cpoint    
    if variabel_tujuan == Point_satu:
        print("Dari R10 menuju RK")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_dua:
        print("Dari R10 menuju R1")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_tiga:
        print("Dari R10 menuju R2")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_empat:
        print("Dari R10 menuju R3")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_lima:
        print("Dari R10 menuju R4")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_enam:
        print("Dari R10 menuju R5")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_tujuh:
        print("Dari R10 menuju R6")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_delapan:
        print("Dari R10 menuju R7")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_sembilan:
        print("Dari R10 menuju R8")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_sepuluh:
        print("Dari R10 menuju R9")
        """"""
        variabel_cpoint = variabel_tujuan
...
def R11():
    ...
    global variabel_cpoint    
    if variabel_tujuan == Point_satu:
        print("Dari R11 menuju RK")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_dua:
        print("Dari R11 menuju R1")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_tiga:
        print("Dari R11 menuju R2")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_empat:
        print("Dari R11 menuju R3")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_lima:
        print("Dari R11 menuju R4")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_enam:
        print("Dari R11 menuju R5")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_tujuh:
        print("Dari R11 menuju R6")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_delapan:
        print("Dari R11 menuju R7")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_sembilan:
        print("Dari R11 menuju R8")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_sepuluh:
        print("Dari R11 menuju R9")
        """"""
        variabel_cpoint = variabel_tujuan
    
    if variabel_tujuan == Point_sebelas:
        print("Dari R11 menuju R10")
        """"""
        variabel_cpoint = variabel_tujuan
...
def kontrol_manual():
    subprocess.Popen(["python3", "/home/pi/Robot_19/kontrol_motor_tanpa_qr.py"], stdout=PIPE, stderr=PIPE)

def diam():
    subprocess.Popen(["python3", "/home/pi/Robot_19/kontrol_motor_diam.py"], stdout=PIPE, stderr=PIPE)
...
class App:
    def __init__(self, master, video_source=1):
        ...
        self.manual_button=tkinter.Button(master, text="Manual", width=50, command=lambda:self.close_window())#[ self.close_window(), self.manual_lunch()])
        self.manual_button.pack(anchor=tkinter.CENTER, expand=True)
        self.exit_button=tkinter.Button(master, text="Exit", width=50, command=lambda: self.exit_to_manual())
    ...
    def manual_lunch(self):
        kontrol_manual()
    
    def exit_to_manual(self):
       global Exit
       Exit = "1"
       self.master.destroy()
...
class Win2(App):
    ...
    def autonomus_panel(self):
        ...
        self.force_close.grid(row=1, column=2, padx=5, pady=5)
...
class Win3(App):
    ...
    def manual_panel(self):
        ...
        self.quit = tk.Button(
            ...
            command=lambda:self.close_window())#[, self.manual_lunch()])
        self.quit.pack()
        self.frame.pack()
